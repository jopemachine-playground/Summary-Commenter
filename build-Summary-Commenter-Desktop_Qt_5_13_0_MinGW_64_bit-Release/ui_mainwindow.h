...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QIcon icon6;
        icon6.addFile(QString::fromUtf8(":/new/img/res/img/alert-triangle.ico"), QSize(), QIcon::Normal, QIcon::Off);
        actionRemove_Comments_From_All_File->setIcon(icon6);
        ...
        QIcon icon7;
        icon7.addFile(QString::fromUtf8(":/new/img/res/img/settings.ico"), QSize(), QIcon::Normal, QIcon::Off);
        actionOpen_setting_file->setIcon(icon7);
        actionNew = new QAction(MainWindow);
        actionNew->setObjectName(QString::fromUtf8("actionNew"));
        QIcon icon8;
        icon8.addFile(QString::fromUtf8(":/new/img/res/img/plus-circle.ico"), QSize(), QIcon::Normal, QIcon::Off);
